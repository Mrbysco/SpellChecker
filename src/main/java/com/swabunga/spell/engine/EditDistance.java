...
public class EditDistance {
   ...
   */
  static final int costOfDeletingSourceCharacter = Configuration.COST_REMOVE_CHAR;
  static final int costOfInsertingSourceCharacter = Configuration.COST_INSERT_CHAR;
  static final int costOfSubstitutingLetters = Configuration.COST_SUBST_CHARS;
  static final int costOfSwappingLetters = Configuration.COST_SWAP_CHARS;
  static final int costOfChangingCase = Configuration.COST_CHANGE_CASE;  
